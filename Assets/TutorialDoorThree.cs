...
public class TutorialDoorThree : MonoBehaviour
{
    ...
    protected bool RoomThreeCompleted() { return GameObject.Find("Character").GetComponent<TutorialMovment>().RoomThreeCompleted; }
    ...
    void OnTriggerStay2D(Collider2D collissionobject)
    {
        ...
        if (collissionobject.gameObject.tag == "Player")
        {
            ...
            if (Input.GetButton("Interact") && RoomThreeCompleted())
            {
