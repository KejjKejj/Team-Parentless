...
public class TutorialDoorScript : MonoBehaviour
{
    ...
    protected bool RoomOneCompleted() { return GameObject.Find("Character").GetComponent<TutorialMovment>().TasksCompleted; }
    ...
    void OnTriggerStay2D(Collider2D collissionobject)
    {
        ...
        if (collissionobject.gameObject.tag == "Player" )
        {
            ...
            if (Input.GetButton("Interact") && RoomOneCompleted())
            {
