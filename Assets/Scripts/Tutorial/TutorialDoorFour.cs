...
public class TutorialDoorFour : MonoBehaviour
{
    ...
    protected bool RoomFourCompleted() { return GameObject.Find("Character").GetComponent<TutorialMovment>().RoomFourCompleted; }
    ...
    void OnTriggerStay2D(Collider2D collissionobject)
    {
        ...
        if (collissionobject.gameObject.tag == "Player")
        {
            ...
            if (Input.GetButton("Interact") && RoomFourCompleted())
            {
