...
public class TutorialMovment : MonoBehaviour
{
    ...
    public bool Mouse2Pressed = false;
    public bool TasksCompleted = false;
    public bool Knifed = false;
    private int UseKnife = 0;
    private int Shooting = 0;
    private int Shooting4 = 0;
    public bool RoomThreeCompleted = false;
    public bool RoomFourCompleted = false;
    ...
    void Move()
    {
        ...
        if (Input.GetKey(KeyCode.W)) { KeyWPressed = true; }
        if (Input.GetKey(KeyCode.A)) { KeyAPressed = true; }
        if (Input.GetKey(KeyCode.S)) { KeySPressed = true; }
        if (Input.GetKey(KeyCode.D)) { KeyDPressed = true; }
        if (Input.GetMouseButtonDown(1)) { Mouse2Pressed = true; }
        if (KeyWPressed && KeyAPressed && KeySPressed && KeyDPressed && Mouse2Pressed) { TasksCompleted = true; }
        ...
        if (PlayerInsideRoom3())
        {
            ...
            if (Shooting >= 1)
            {
                RoomThreeCompleted = true;
            }
            else
            {
                RoomThreeCompleted = false;
            }
        }
